...
export class PlanningProviderContractError extends TypeError {
  readonly code = 'PLANNING_PROVIDER_CONTRACT_INVALID';

  constructor(message: string) {
    super(message);
    this.name = 'PlanningProviderContractError';
  }
}
...
function providerContractInvalid(
  ...
  return new PlanningProviderContractError(message);
}
