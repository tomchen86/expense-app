...
import {
  ...
  replaceTextAtomic,
} from '../../repository-transaction/atomic-text.ts';
...
import {
  ...
  validateHandoff,
} from '../../../adapters/consumer/expense-app/handoff/handoff.ts';
import { validateIssueLog } from '../../../adapters/consumer/expense-app/documents/issues.ts';
