...
} from '../../../../runtime/repository-transaction/package-closure.ts';
...
function nodeTestPrefix(args: string[], entrypointStart: number): string[] {
  const prefixEnd =
    args[entrypointStart] === '--test-concurrency=4'
      ? entrypointStart + 1
      : entrypointStart;
