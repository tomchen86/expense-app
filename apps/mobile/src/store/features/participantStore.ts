...
export interface ParticipantState {
  ...
  syncUserAsParticipant: (internalUserId: string, userSettings: UserSettings | null) => void;
}
...
export const useParticipantStore = create<ParticipantState>((set, get) => ({
  ...
  syncUserAsParticipant: (internalUserId: string, userSettings: UserSettings | null) => {
    if (!internalUserId || !userSettings?.name) return;
